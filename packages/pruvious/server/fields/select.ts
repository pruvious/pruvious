...
export type ExtractSelectChoicesValues<T extends readonly (SelectChoice | SelectChoiceGroup)[]> =
  T[number] extends infer Item
    ? Item extends { choices: readonly any[] }
      ? Item['choices'][number]['value']
      : Item extends { value: string }
        ? Item['value']
        : never
    : never
...
export default {
  ...
  serverFn: function <
    ...
    const TValues extends ExtractSelectChoicesValues<TChoices> = ExtractSelectChoicesValues<TChoices>,
  >(
    options: Omit<
