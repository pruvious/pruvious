...
import { dayjsConfig, dayjsUTC } from '#pruvious/dashboard/dayjs'
...
const formattedFrom = computed(() => dayjsUTC(props.modelValue?.[0] ?? 0).format(timeFormat))
const formattedTo = computed(() => dayjsUTC(props.modelValue?.[1] ?? 0).format(timeFormat))
