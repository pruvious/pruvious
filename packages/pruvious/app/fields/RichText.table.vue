...
import { castToNumber, isDefined, isString, stripHTML } from '@pruvious/utils'
...
const strippedValue = computed(() => stripHTML((props.modelValue ?? '').replace(/<br\s*\/?>/gi, '\n')) ?? '')
...
const formattedValue = computed(() => {
  let result = strippedValue.value
