...
definePageMeta({
  ...
  middleware: [
    ...
    (to) =>
      import('../../../../utils/pruvious/dashboard/middleware/collection/routes/index').then((m) => m.default(to)),
  ],
})
...
const canDelete = collection.definition.api.delete && hasPermission('collection:routes:delete' as Permission)
