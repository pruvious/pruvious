...
export async function getServerFileContent() {
  ...
  const content = [
    ...
    ` *`,
    ` * @see https://pruvious.com/docs/query-builder#guards`,
    ` *`,
    ` * @example`,
    ` * \`\`\`ts`,
    ...
    ` *`,
    ` * @see https://pruvious.com/docs/query-builder#insert-into`,
    ` *`,
    ` * @example`,
    ` * \`\`\`ts`,
    ...
    ` *`,
    ` * @see https://pruvious.com/docs/query-builder#guarded-insert-into`,
    ` *`,
    ` * @example`,
    ` * \`\`\`ts`,
    ...
    ` *`,
    ` * @see https://pruvious.com/docs/query-builder#select-from`,
    ` *`,
    ` * @example`,
    ` * \`\`\`ts`,
    ...
    ` *`,
    ` * @see https://pruvious.com/docs/query-builder#guarded-select-from`,
    ` *`,
    ` * @example`,
    ` * \`\`\`ts`,
    ...
    ` *`,
    ` * @see https://pruvious.com/docs/query-builder#update`,
    ` *`,
    ` * @example`,
    ` * \`\`\`ts`,
    ...
    ` *`,
    ` * @see https://pruvious.com/docs/query-builder#guarded-update`,
    ` *`,
    ` * @example`,
    ` * \`\`\`ts`,
    ...
    ` *`,
    ` * @see https://pruvious.com/docs/query-builder#delete-from`,
    ` *`,
    ` * @example`,
    ` * \`\`\`ts`,
    ...
    ` *`,
    ` * @see https://pruvious.com/docs/query-builder#guarded-delete-from`,
    ` *`,
    ` * @example`,
    ` * \`\`\`ts`,
    ...
    `    const runtimeConfig = useRuntimeConfig()`,
    `    const syncDb = typeof process !== 'undefined' && process.env && typeof process.env.PRUVIOUS_SYNC_DB === 'string' && process.env.PRUVIOUS_SYNC_DB.trim() ? process.env.PRUVIOUS_SYNC_DB.trim() : null`,
    `    const skipBootSync = typeof process !== 'undefined' && process.env && !!process.env.PRUVIOUS_SKIP_BOOT_SYNC`,
    `    _mainDatabase = new Database({`,
    `      ...runtimeConfig.pruvious.database,`,
    `      ...(syncDb ? { driver: ('sqlite://' + syncDb) as DatabaseDriver } : {}),`,
    ...
    `      logger: log,`,
    `      i18n,`,
    `      sync: skipBootSync ? false : (runtimeConfig.pruvious.database.sync === false ? false : {`,
...
function getReExports() {
  ...
  return [
    ...
    `export { validateImageTransformOptions, optimizeImage } from '${resolvePruviousFile('uploads/images')}'`,
