...
function getServerFileContent() {
  ...
  return [
    ...
    `import { queueUniqueJob } from '${resolve('../queue/utils.server')}'`,
...
function getReExports() {
  ...
  return [
    ...
    `export { type ImageVariantOptions, type ImageTransformOptions, stringifyImageTransformOptions, parseImageTransformOptions, normalizeImageTransformOptions, validateImageTransformOptions, optimizeImage, generateOptimizedImagePath, normalizeOptimizedImagePath } from '${resolve('../uploads/images')}'`,
    ...
    `export { type CustomLogOptions, type ErrorLogOptions, customLog, logError } from '${resolve('../debug/utils.server')}'`,
