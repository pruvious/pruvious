...
type SingletonCopyTranslationFunction<
  ...
  TUpdateInput extends Record<string, any> = UpdateInput<{
    fields: TAllFields
  }>,
> = (context: {
  /**
   ...
   */
  source: ExtractCastedTypes<TAllFields>
...
> extends Readonly<ISingleton> {
  ...
  readonly syncedFields: (keyof TFields & string)[]
  ...
  readonly copyTranslation: SingletonCopyTranslationFunction<TFields, TUpdatedAt> | null
  readonly logs: SingletonLogsOptions
  readonly updatedAt: AutoFieldEnabled & UpdatedAtFieldPresetOptions & Required<BaseUpdatedAtFieldOptions>
  readonly ui: SingletonUIOptions
   ...
   */
  readonly TFieldNames: keyof TFields
   ...
   * Note: This is a TypeScript type assertion and does not involve any runtime logic or data.
   */
  readonly TNullableFields: ExtractNullableFieldNames<TFields>
   ...
   * Note: This is a TypeScript type assertion and does not involve any runtime logic or data.
   */
  readonly TAutoGeneratedFields: ExtractAutoGeneratedFieldNames<TFields>
   ...
   * Note: This is a TypeScript type assertion and does not involve any runtime logic or data.
   */
  readonly TConditionalFields: ExtractConditionalFieldNames<TFields>
}
...
> extends BaseDefineSingletonOptions {
   ...
   * ```
   */
  copyTranslation?: SingletonCopyTranslationFunction<TFields, TUpdatedAt> | null
   ...
   * }
   */
  ui?: PartialMax2Levels<SingletonUIOptions<keyof TFields & string>>
}
...
>(
  ...
  DefaultFalse<TTranslatable>,
  DefaultTrue<TUpdatedAt>
> {
  return function (resolveContext: ResolveContext) {
    ...
    for (const fieldName of Object.keys(fields)) {
      if (updatedAt.enabled && fieldName === updatedAt.fieldName) {
