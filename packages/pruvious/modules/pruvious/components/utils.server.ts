 ...
 * This object can be imported from `#pruvious/dashboard` and is used on the client-side to dynamically import custom components.
...
/**
 * Resolves a custom Vue component by its `path` for use in a Pruvious field, collection, or singleton option.
 * The resolved component is accessible in the client-side context through `#pruvious/dashboard` and can be referenced as `customComponents[name]`.
 * This function should only be used in the server-side context within the following directories:
 *
 * - `<srcDir>/<pruvious.dir.blocks>`
 * - `<serverDir>/<pruvious.dir.collections>`
