...
import { getTimezoneOffset, toDate, toSeconds, toSQLDateTime } from '../../src'
...
test('get timezone offset', () => {
  expect(getTimezoneOffset('America/New_York', new Date('2021-01-01T00:00:00.000Z'))).toEqual(-300)
  expect(getTimezoneOffset('Europe/London', new Date('2021-01-01T00:00:00.000Z'))).toEqual(0)
  expect(getTimezoneOffset('Europe/London', new Date('2021-06-01T00:00:00.000Z'))).toEqual(60)
  expect(getTimezoneOffset('Europe/Berlin', new Date('2021-01-01T00:00:00.000Z'))).toEqual(60)
  expect(getTimezoneOffset('Europe/Berlin', new Date('2021-06-01T00:00:00.000Z'))).toEqual(120)
  expect(getTimezoneOffset('Asia/Tokyo', new Date('2021-01-01T00:00:00.000Z'))).toEqual(540)
})
