...
export default defineCommand({
  ...
  async run(ctx) {
    ...
    try {
      ...
      packageJson.devDependencies.nuxt = '^3.9.1'
      packageJson.devDependencies.vue = '^3.4.10'
      packageJson.devDependencies['vue-router'] = '^4.2.5'

      // Add pruvious
      packageJson.dependencies ??= {}
      packageJson.dependencies.pruvious = '^3.9.6'
...
export function replaceReadme(cwd?: string) {
  fs.writeFileSync(
    ...
    [
      '# Project',
      'This project was generated with [Pruvious](https://pruvious.com) CLI version 3.9.6.',
      '',
