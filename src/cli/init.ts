...
export default defineCommand({
  ...
  async run(ctx) {
    ...
    try {
      ...
      packageJson.dependencies.nuxt = '^3.11.1'
      packageJson.dependencies.vue = '^3.4.21'
      packageJson.dependencies['vue-router'] = '^4.3.0'

      // Add pruvious
      packageJson.dependencies.pruvious = '^3.11.1'
...
export function replaceReadme(cwd?: string) {
  fs.writeFileSync(
    ...
    [
      '# Project',
      'This project was generated with [Pruvious](https://pruvious.com) CLI version 3.11.1.',
      '',
