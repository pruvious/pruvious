...
export default defineCommand({
  ...
  async run(ctx) {
    ...
    try {
      ...
      packageJson.devDependencies.nuxt = '^3.9.3'
      packageJson.devDependencies.vue = '^3.4.14'
      packageJson.devDependencies['vue-router'] = '^4.2.5'

      // Add pruvious
      packageJson.dependencies ??= {}
      packageJson.dependencies.pruvious = '^3.9.10'
...
export function replaceReadme(cwd?: string) {
  fs.writeFileSync(
    ...
    [
      '# Project',
      'This project was generated with [Pruvious](https://pruvious.com) CLI version 3.9.10.',
      '',
