...
export default defineCommand({
  ...
  async run(ctx) {
    ...
    try {
      ...
      packageJson.dependencies.nuxt = '~3.14.0'
      packageJson.dependencies.vue = '^3.5.13'
      packageJson.dependencies['vue-router'] = '^4.5.0'

      // Add pruvious
      packageJson.dependencies.pruvious = '^3.13.4'
...
export function replaceReadme(cwd?: string) {
  fs.writeFileSync(
    ...
    [
      '# Project',
      'This project was generated with [Pruvious](https://pruvious.com) CLI version 3.13.4.',
      '',
